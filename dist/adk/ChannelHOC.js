...
function withChannel(WrappedComponent) {
  var WithChannel = /*#__PURE__*/function (_React$Component) {
    _inherits(WithChannel, _React$Component);

    var _super = _createSuper(WithChannel);

    function WithChannel() {
      var _this;

      _classCallCheck(this, WithChannel);
  ...
  WithChannel.displayName = "WithSubscription(".concat(getDisplayName(WrappedComponent), ")");
  return WithChannel;
